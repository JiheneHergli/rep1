...
eventModel.addEvent(new DefaultScheduleEvent ("Le personnel " +cong.getPersonnel().getPrenom() + cong.getPersonnel().getNom() + " a un congé de type "+ cong.getTypeconge().getType() , cong.getDate_debut() , cong.getDate_fin(),"background-color: #cong.getTypeconge().getColor()") );
